...
import type { ArtworkFormData } from "@modules/artwork/components/artwork-form";
import { ArtworkForm } from "@modules/artwork/components/artwork-form";
...
const CreatePage: NextPage = () => {
	...
	return (
		<ContentSection className="grid grid-cols-1 gap-8 md:grid-cols-2">
